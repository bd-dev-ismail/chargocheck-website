      ...
      <div className="px-4 py-16 mx-auto min-h-screen sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid gap-10 place-items-center lg:grid-cols-2">
          <div className="lg:pr-10">
            ...
            <h5 className="mb-4 text-4xl font-extrabold leading-none">The Wildlife</h5>
            <p className="mb-6 text-gray-900">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae explicabo. Sed ut
              perspiciatis unde omnis iste natus error sit voluptatem totam rem aperiam, eaque ipsa quae explicabo.
            </p>
            <p className="mb-6 text-gray-900">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae explicabo. Sed ut
              perspiciatis unde omnis iste natus error sit voluptatem totam rem aperiam, eaque ipsa quae explicabo.
          ...
          <div>
            <img className="object-cover w-full h-56 rounded shadow-lg sm:h-96" src="https://cms.cargocheck.com/uploads/thumbnail_image_10_5_a6b0d38c8b.png" alt="" />
          </div>
        </div>
      </div>
    </div>
